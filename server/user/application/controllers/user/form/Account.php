...
class Account extends CI_Controller{
    ...
    $this->form_validation->set_rules('phoneCode', 'Phone code');
    $this->form_validation->set_rules('phone', 'Phone number');
    $this->form_validation->set_rules('personalid', 'Personal number');
    ...
    if ($this->form_validation->run()==false) {
        ...
        die();
            ...
            if ($this->input->post('personalid')=="") {
                $id = 'N'.date("y").(int)microtime(true);
            }else{
