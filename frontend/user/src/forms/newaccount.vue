...
<div class="row d-flex justify-content-center p-0">
 ...
 <div class="col-md-6 mt-1">
            ...
            <div class="col-md-6">
                <div class="m-1 mt-3">
                    <label for="personalid" class="pb-1 text-muted">NIN (If any) </label>
                <div class="input-group">
                    <span class="input-group-text"><i class="bi-person"></i></span>
                    <input type="text" v-model="personalid" minlength="10" maxlength="40" id="fname" class="form-control form-control-md form-control-sm-lg" placeholder="National identity number">
                </div>
                <small class="form-text text-muted"></small>
        ...
        <div class="col-md-6">
                ...
                <div class="input-group">
                    <select class="form-control form-control-md form-control-sm-lg" v-model="phoneCode" id="code">
                ...
                <div class="input-group">
                    <input type="text" @change="checkPhone" v-model="phone_one" minlength="7" maxlength="15" id="phone" class="form-control form-control-md form-control-sm-lg" placeholder="Number only">
                    </div>
...
export default {
   ...
   tokenize: function(){
    ...
    checkPhone: function(){
    if(this.phone_one != '' && this.phone_one.startsWith(0)){
   ...
   if(!this.password.match(/[a-z]+/) || !this.password.match(/[A-Z]+/) || !this.password.match(/[0-9]+/)){
    ...
    addNew: function(){
        ...
        form.append('personalid', this.personalid)
