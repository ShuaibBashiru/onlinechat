...
<form @submit.prevent="formCheck" class="needs-validation">
            ...
            <div class="col-md-5">
                ...
                <div class="input-group">
                    ...
                    <input type="text" v-model="category" class="form-control" disabled readonly>
                </div>
...
export default {
    ...
    e.preventDefault();
       ...
       preview: function(){
        ...
        axios.get(process.env.VUE_APP_API_URL+'/api/adminwebmenu/validate_id/', {
            params:{
        ...
        .then(response => {
            ...
            this.menuicon = this.info['menuIcon']
    ...
    delete: function(){
        ...
        form.append('itemName', this.menuname)
        form.append('csrfmiddlewaretoken', this.token)
        axios.post(process.env.VUE_APP_API_URL+'/posts/adminwebmenu/delete/', form,{
        }).then(response => {
        if(response.data.status==response.data.statusmsg){
        this.classname=response.data.classname
        this.alert=response.data.msg
